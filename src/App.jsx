...
import DeepanshuAbout from "./assets/DeepanshuAbout.png";
      ...
      <footer className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md py-8 border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0 text-gray-600 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Deepanshu Dhakad. All rights reserved.
          </p>
          
          <div className="flex space-x-6">
            <motion.a 
              href="https://github.com/deepanshu8000"
              target="_blank" 
            ...
            <motion.a 
              href="https://www.linkedin.com/in/deepanshu-dhakad" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-purple-400 transition-colors"
              whileHover={{ scale: 1.2, rotate: -5 }}
    ...
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      >
        ...
        <motion.p
          ...
          custom={2}
        >
          Software Developer passionate about creating beautiful, functional applications
        </motion.p>
      </motion.div>
...
function About() {
  const skills = [
    ...
    { name: "Node.js",icon: <FaReact className="text-cyan-400" />},
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div className="order-2 md:order-1">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>
            I am a passionate MERN Stack Developer aspiring to build modern and scalable 
            web applications. I enjoy learning new technologies and continuously improving 
            my skills in MongoDB, Express.js, React.js, Node.js, and JavaScript. 
            I love turning ideas into real-world projects while writing clean, efficient, and maintainable code.
          </p>
          
          <p>
            I enjoy creating responsive and user-friendly interfaces using React, while also working on
             backend development with Node.js and MongoDB to deliver complete full-stack solutions.
          </p>
          
          <p>
            Beyond coding, I like exploring new technologies, working on personal projects,
             and participating in hackathons to challenge myself and gain real-world development experience.
          </p>
        </div>
        <div className="mt-8">
    ...
    {skills.map((skills, index) => (
      ...
      >
        <div className="relative group">
          ...
          <img
            src={DeepanshuAbout}
            alt="Deepanshu working"
            className="w-full max-w-sm mx-auto rounded-xl shadow-2xl object-cover transform group-hover:-translate-y-1 transition-transform duration-300"
            />
        </div>
...
function Education() {
  const educationData = [
    ...
    },
    {
      ...
      institution: "Bhuvnesh Bal Vidyalaya",
      year: "2022- 2023",
...
function Projects() {
  const projects = [
    { 
      id: 1, 
      image: "https://github.com/deepanshu8000/Personal-Portfolio-Page/blob/main/src/assets/simplepoetfolio%20(2).png?raw=true",
      title: 'Car Rentals Website', 
      description: 'A MERN stack-based Car Rental Web App that allows users to explore, view, and book cars with a responsive and user-friendly interface.', 
      link: "https://dcarrental.vercel.app/",
      repo:"https://github.com/deepanshu8000/CarRentals",
      icon: <Car className="text-green-500" size={20} />, 
      tags: ['MongoDB', 'Express.js','React', 'Node.js']
    },
    { 
      id: 2, 
      image: "https://github.com/deepanshu8000/Personal-Portfolio-Page/blob/main/src/assets/simplepoetfolio%20(1).png?raw=true",
      title: 'Simple Portfolio', 
      description: 'A simple portfolio website built using HTML and CSS', 
      link: "https://deepanshu26.vercel.app/",
      repo:"https://github.com/deepanshu8000/portfolio-html-css",
      icon: <CodeIcon className="text-pink-500" size={20} />, 
      tags: ['HTML', 'CSS']
    },
    { 
      id: 3, 
      image: "https://github.com/deepanshu8000/Personal-Portfolio-Page/blob/main/src/assets/portfolio.png?raw=true",
      title: 'Personal Portfolio', 
      description: 'A responsive personal portfolio website highlighting projects, technical skills, and professional details.', 
      link: "https://deepanshu125.vercel.app",
      repo: "https://github.com/deepanshu8000/Personal-Portfolio-Page",
      icon: <CodeIcon className="text-green-500" size={20} />,
  ...
  return (
    <div className="w-full">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Here are some of my recent projects, each developed to solve real-world problems and explore modern web technologies.
        </p>
      </div>
...
function Certificates() {
  const certificates = [
    { id: 1, title: 'Enigma Inter College Hackathon', issuer: 'RIET', year: '2026', link:"https://github.com/deepanshu8000/Personal-Portfolio-Page/blob/main/src/Enigma.jpeg?raw=true" },
    { id: 2, title: 'Google Launchpad - Gen AI', issuer: 'Google Cloud', year: '2026', link:"https://github.com/deepanshu8000/Personal-Portfolio-Page/blob/main/src/assets/GenAI_page-0001.jpg?raw=true" },
    { id: 3, title: 'Oracle Certified Foundation Associates', issuer: 'Oracle University', year: '2025', link:"https://github.com/deepanshu8000/Personal-Portfolio-Page/blob/main/src/assets/eCertificate_page-0001.jpg?raw=true" },
    { id: 4, title: 'Gen AI Study Jams Program', issuer: 'Google Cloud', year: '2025',link:"https://github.com/deepanshu8000/Personal-Portfolio-Page/blob/main/src/assets/91.png?raw=true" },
  ]
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://email-server-er04.onrender.com/api/send-email', {
        ...
        body: JSON.stringify({
          ...formData,
          to: 'deepanshudhakad381@gmail.com' // Your email address
        }),
      });
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-lg mx-auto">
          Got an idea, project, or opportunity in mind? Feel free to reach out — I’m always open to meaningful conversations and collaborations.
        </p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a 
                  href="www.linkedin.com/in/deepanshu-dhakad/deepanshu-dhakad" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-500 dark:text-purple-400 hover:underline"
                >
                 linkedin.com/in/deepanshu-dhakad
                </a>
              </div>
            </div>
